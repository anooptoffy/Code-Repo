 ...
 * @Author : Anoop Toffy
 * If size and append need to be fast (constant time as against O(n)), what changes would you make?
 * Add a reference to last node, so append can take O(1) time. For size return the value of this.pos
 * instead of looping the entire list.
 * 
 */
public class LList {
